const words = [
    // Eye Colors
    { word: "blue (eyes)", translation: "azul" },
    { word: "brown (eyes)", translation: "marrones" },
    { word: "green (eyes)", translation: "verdes" },

    // Hair Colors and Styles
    { word: "dark brown (hair)", translation: "moreno" },
    { word: "blonde (hair)", translation: "rubio" },
    { word: "curly (hair)", translation: "rizado" },
    { word: "long (hair)", translation: "largo" },
    { word: "short (hair)", translation: "corto" },
    { word: "red (hair)", translation: "rojo" },
    { word: "straight (hair)", translation: "liso" },
    { word: "brown (hair)", translation: "castanno" },
    { word: "fine (hair)", translation: "fino" },
    { word: "wavy (hair)", translation: "ondulado" },
    { word: "spiky (hair)", translation: "de punta" },
];
let currentIndex = -1;
let correctCount = 0;
let wrongCount = 0;
